      ...
      return( 
        ...
        <Statistic
          ...
          ( 
           ...
           <Graph labels={this.state.lablesnifti} data={this.state.datanifti} title="nifti"  grad="#3399ff" border="#4d94ff"/>
         {/* </Card> */}
         </Col>
      <Col span={6}>
         {/* <Card style={{ width: "45vh",height:"35vh" }}> */}
        ...
        <Statistic
          ...
          ( 
           ...
           <Graph labels={this.state.lablessensex} data={this.state.datasensex} title="sensex" grad="#99e699" border="#29a329"/>
         {/* </Card> */}
         </Col>
         <Col span={6}>
         {/* <Card style={{ width: "45vh",height:"35vh" }}> */}
        <Statistic
          ...
          ( 
           ...
           <Graph labels={this.state.lablesbank} data={this.state.databank} title="NIFTI Bank" grad="#ff66ff" border="#ff4dff"/>
         {/* </Card> */}
         </Col>
         <Col span={6}>
         {/* <Card style={{ width: "45vh",height:"35vh" }}> */}
        <Statistic
          ...
          ( 
           ...
           <Graph labels={this.state.lablesindia} data={this.state.dataindia} title="INDIA vix" grad="#ff9933" border="#ff6600"/>
         {/* </Card> */}
         </Col>
    </Row>
    <Row gutter={16}>
